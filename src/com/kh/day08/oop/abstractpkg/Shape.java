...
abstract class Line extends Shape {
	...
	// => 추상메소드 오버라이딩 or class에 abstract 붙이기
//	@Override
//	public void draw() {
//		
//	}
...
public abstract class Shape {
	...
	// 1. Abstract methods do not specify a body => {} 제거
	// 2. The abstract method draw in type Shape can only be defined by an abstract class
	// 3. The type Shape must be an abstract class to define abstract methods => class에 abstract 붙이기
}
